...
![Alt text](img/dashboard_new_1.png)

## Seccion 1

![Alt text](img/dashboard_new_2.png)
...
![alt text](img/dashboard_new_3.png)
...
![Alt text](img/dashboard_new_4.png)

Grafico de la suma de totales de notas de venta y comprobantes emitidos.  

---  

## Seccion 2

![Alt text](img/dashboard_new_5.png)
...
![Alt text](img/dashboard_new_6.png)
...
![alt text](img/dashboard_new_8.png)
...
![alt text](img/dashboard_new_7.png)
...
5. **Aprovisionar**: Botón para aprovisionar el producto, al hacer clic en este boton sera redirigido a la pestaña de **Compras**
