...
Ingresa al módulo de **Ventas**, y luego selecciona la subcategoría **Boleta/Factura**. Selecciona la opcion de **Tipo de Operación** y cambia a **Operación Sujeta a Detracción**.

![Alt text](img/comprobante_detraccion_new_1.png)
