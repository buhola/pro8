---
sidebar_position: 1
title: Emitir comprobantes por anticipo y su deducción
---
...
Ingresa al **módulo de Ventas** y luego en la subcategoría **Boleta/Factura**, realiza clik en el boton **Crear**.

![Alt text](img/comprobante_por_anticipo_deduccion_new_1.png)
...
![Alt text](img/comprobante_por_anticipo_deduccion_new_2.png)
...
![Alt text](img/comprobante_por_anticipo_deduccion_new_3.png)
...
![Alt text](img/comprobante_por_anticipo_deduccion_new_4.png)
...
En esta sección de **Información adicional**, ubicada en la seccion derecha, del formulario

![Alt text](img/comprobante_por_anticipo_deduccion_new_6.png)

Se activará el botón deslizante de **¿Es un pago anticipado?**, hasta que se muestre en azul y se dejará por defecto la opción **Gravado**, de tener otra afectación seleccionela.

![Alt text](img/comprobante_por_anticipo_deduccion_new_5.png)

Después selecciona el botón **Generar** y  aparecerá una ventana,indicando que la factura/boleta ha sido aceptada.

![Alt text](img/comprobante_por_anticipo_deduccion_new_7.png)

Además podrás escoger el formato del comprobante electrónico en tamaño **A4(vertical) y A5(horizontal)**.
...
![Alt text](img/comprobante_por_anticipo_deduccion_new_9.png)

Luego visualizaremos que en la parte de descripción, se estarán añadiendo los anticipos.

![Alt text](img/comprobante_por_anticipo_deduccion_new_10.png)
