...
Mozo Compilado requiere un hosting básico. Con 1 GB de almacenamiento puedes alojar, en promedio, entre 7 y 9 instalaciones ligeras (puede variar según archivos, imágenes y respaldos). Consulta la [documentación de instalación](Instalacion-Mozo-cPanel.md) para más detalles.
::::
